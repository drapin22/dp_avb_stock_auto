...
TELEGRAM_MAX_CHARS = 3900  # puțin sub 4096 ca să evităm erori
...
def send_telegram_long_message(text: str, parse_mode: str | None = None, sleep_s: float = 0.4) -> None:
    """
    ...
    for line in lines:
        ...
        if len(candidate) <= TELEGRAM_MAX_CHARS:
            ...
            if cur:
                chunks.append(cur)
            # dacă linia singură e prea mare, o tăiem brut
